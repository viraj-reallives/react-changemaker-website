...
const outPath = join(__dirname, "../src/i18n/en.json");
const localesPath = join(__dirname, "../src/i18n/locales/en.json");

const en = {
  portal: {
    hero: {
      title: "Step out of your life and into a billion more",
      subtitle: "Live | Feel | Understand | Change",
    },
    languages: {
      title: "Language",
    ...
    realLives: {
      ariaLabel: "RealLives",
      title: "RealLives Simulation Platform",
      subtitle: "Experience lives across the world",
      description:
      ...
      cta: "Continue to RealLives",
      features: {
        liveALife: "live a life",
        realWorldData: "real world data",
        empathySimulation: "Empathy simulation",
      },
    },
    changeMaker: {
      ariaLabel: "ChangeMaker Index",
      title: "RealLives ChangeMaker Index (RCMI)",
      subtitle: "Turn insight into real-world impact",
      description:
        "Measure and grow across 18 changemaking competencies. Reflect on your decisions, understand your impact, and build skills that prepare you for future careers and responsible leadership.",
      cta: "Go to RealLives ChangeMaker Index",
      features: {
        skills: "21ST CENTURY SKILLS",
        empathy: "EMPATHY",
        sdg: "sdg lived experience",
      },
    },
    copyright: "© 2026 RealLives World. All rights reserved.",
  },
  ...
  common: {
    ...
    home: "Home",
    alt: {
      changemakerIndexImage: "ChangeMaker Index image",
      logo: "logo",
      img: "img",
      rcmi: "RCMI",
      realLivesFoundation: "RealLives Foundation",
      arcadeDemo: "Arcade Demo",
    },
    nav: {
      home: "Home",
    ...
    signupModal: {
      chooseTitle: "Who is this report for?",
      chooseSubtitle: "Choose your path to see how RCMI is designed for you.",
      close: "Close",
      back: "Back",
      cta: "Get Your RCMI Report",
      types: {
        school: {
          title: "School",
          short: "For classrooms and school leaders",
          benefitsTitle: "How RCMI helps schools",
          headline: "Make character growth visible across the whole school.",
          photoCaption: "Orchid School ChangeMaker Workshop",
          benefits: [
            {
              title: "See how each class is doing",
              text: "A map of all 18 competencies and four clusters for a grade or section, so SEL planning is based on evidence.",
            },
            {
              title: "Show that a workshop made a difference",
              text: "Pre and post scores show whether a workshop, club, or value-education period actually moved students.",
            },
            {
              title: "Ready text for NEP 2020 report cards",
              text: "Gives teachers clear competency wording for the non-academic parts of holistic progress cards.",
            },
            {
              title: "Find students who need support",
              text: "Blind Spot patterns help teachers see students who overrate themselves in areas like empathy or resilience.",
            },
            {
              title: "Tell parents you measure character",
              text: "“We measure character, not just marks” becomes a concrete differentiator for admissions.",
            },
          ],
        },
        university: {
          title: "University Department",
          short: "For faculties, programmes, and cohorts",
          benefitsTitle: "How RCMI helps university departments",
          headline: "Prove the skills employers and funders keep asking for.",
          photoCaption: "RealLives workshops with university partners",
          benefits: [
            {
              title: "Ready for papers, theses, and grants",
              text: "36 situational items, a clear scoring model, and a pre/post design for theses, papers, and grants.",
            },
            {
              title: "Proof for NAAC, NIRF, and accreditation",
              text: "Competencies such as Strategic Thinking map onto the graduate attributes departments must show.",
            },
            {
              title: "A profile students can take to interviews",
              text: "Students leave with a competency snapshot for interviews; placement cells see cohort strengths.",
            },
            {
              title: "See which courses actually helped",
              text: "Compare batches year on year to see which courses or internships shift which clusters.",
            },
            {
              title: "Partner with RealLives on research",
              text: "Co-design studies with RealLives, including cross-institution or cross-country comparisons.",
            },
          ],
        },
        homeschooler: {
          title: "Home Schooler",
          short: "For families learning at home",
          benefitsTitle: "How RCMI helps home schoolers",
          headline: "See the life skills home learning is meant to build.",
          benefits: [
            {
              title: "Growth you can show, not just grades",
              text: "A report that shows how your child is growing as a person: empathy, resilience, and good decisions, not only academics.",
            },
            {
              title: "Know what to work on next",
              text: "See which skills to practise next, like working with others or thinking through big problems, instead of guessing.",
            },
            {
              title: "An answer when people ask about social skills",
              text: "When relatives wonder if home learning is too isolated, you have a clear picture of how your child relates to others.",
            },
            {
              title: "A report you can attach to applications",
              text: "A formal document for college, open-school boards, and programmes that want more than a transcript.",
            },
            {
              title: "Something to talk about as a family",
              text: "See where your child is stronger than they think, and where they may be overconfident. Then talk about it together.",
            },
          ],
        },
        gamer: {
          ...
          benefits: [
            {
              title: "Find your Hidden Strengths",
              text: "RCMI surfaces skills like strategic thinking or influence that you already have but may not see.",
            },
            {
              title: "See what’s holding ideas back",
              text: "Blind Spots show what to build so a project, campaign, or startup idea actually reaches people.",
            },
            {
              title: "A credential beyond your portfolio",
              text: "Show funders, fellowships, and competitions how you work, not only what you make.",
            },
            {
              title: "Grow on your own terms",
              text: "No classroom needed. Use the profile as a personal guide and retake it to track progress.",
            },
            {
              title: "Join the ChangeMaker community",
              text: "A path into RealLives workshops where these competencies meet real problems.",
            },
          ],
        },
      },
    ...
    footer: {
      ...
      description:
        "RCMI helps people worldwide build empathy, ethical thinking, and social responsibility through immersive life simulations. By navigating realistic scenarios and reflecting on their decisions, they develop the skills and mindset to create meaningful, positive impact in their communities and beyond.",
      getToKnow: "Get to Know",
      aboutRcmi: "About RCMI",
      certifiedInstitutes: "Certified institutes",
      ourImpact: "Our Impact",
      support: "Support",
    ...
    app: {
      contentProtected: "⚠️ Content is Protected",
    },
    globalMap: {
      title: "Global Impact",
      countries: {
    ...
    impact: {
      impactHome: "Impact Home",
      inCollaborationWith: "In collaboration with:",
      participants: "Participants:",
      skillsDeveloped: "Skills Developed",
      usedTool: "Used tool:",
      sdgAligned: "SDG's Alligned with this workshop",
      objective: "Objective",
      programOverview: "Program Overview",
      implementationMethodology: "Implementation & Methodology",
      crossCulturalExchange: "Cross-Cultural Exchange & Impact",
      outcomesImpact: "Outcomes & Impact",
      studentTestimonial: "Student Testimonial",
      empowerStudents: "Empower Your Students with Global Perspectives",
      beginChangeMakingJourney: "Begin Your ChangeMaking Journey",
      videoUnsupported: "Your browser does not support the video tag.",
    },
    cta: {
      beginYourJourneyOfChange: "Begin Your Journey of Change",
      howThisWorks: "How this works?",
      beginChangeMakerJourney: "Begin Your ChangeMaker Journey",
      makeDecisionsGrowSkills:
  ...
  home: {
    hero: {
      kicker: "RealLives ChangeMaker Index",
      titleLine1: "Beyond Traditional Testing,",
      titleLine2: "Measure What Really Matters",
      description:
        "Life simulation–based assessment that tracks 18 critical competencies through authentic decision-making, not surveys.",
      beginJourney: "Begin Your Journey of Change",
      howThisWorks: "How this works?",
      ethCaption: "ChangeMaker Workshop at ETH Zurich, Switzerland",
      stats: [
        { value: "18", label: "Competencies" },
        { value: "Live", label: "Simulation" },
        { value: "No", label: "Surveys" },
      ],
    },
  },
  ...
  features: {
    ourImpact: {
      title: "Our Impact",
      description:
        "Discover the global footprint of the RealLives Foundation through the workshops and events we've hosted to inspire change.",
      descriptionLineBreak:
        "Discover the global footprint of the RealLives Foundation through the workshops and",
      descriptionLineBreak2:
        "events we've hosted to inspire change.",
      exploreMore: "Explore More Impact Stories",
    },
    changemakerFeatures: {
      title: "RealLives ChangeMaker Index Features",
      description:
        "Discover how the ChangeMaker Index turns your life choices into insights, tracking growth, guiding decisions, and unlocking your potential as a global ChangeMaker.",
      descriptionLineBreak:
        "Discover how the ChangeMaker Index turns your life choices into",
      descriptionLineBreak2:
        "insights, tracking growth, guiding decisions, and unlocking your potential as a global ChangeMaker.",
    },
    impactCards: [
      {
        title: " ETH Zurich, Switzerland",
        description:
          "Students explored global life scenarios in the RealLives ChangeMaking Workshop, building empathy, ethicalleadership, and sustainable problem-solving skills.",
    ...
    featureCards: [
      {
        ...
        description:
          "Students step into diverse real-world lives, experiencing challenges, opportunities, and cultural contexts firsthand. They don't just learn about the world—they live it through immersive simulation.",
      },
      {
        title: "Decisions Tracked",
        description:
          "Every choice—small or big—is recorded and analyzed. This gives students a clear view of how decisions shape outcomes, helping them understand responsibility, ethics, and long-term impact.",
      },
      {
        title: "Insights Delivered",
        description:
          "The system automatically transforms student choices into rich insights, highlighting thinking patterns, strengths, and areas for growth. Educators get an instant window into each learner's mindset.",
      },
      {
        title: "AI Guidance",
        description:
          "Built-in AI coaches students as they play, providing nudges, reflections, and tailored suggestions. It supports deeper self-awareness, critical thinking, and intentional decision-making",
      },
      {
        title: "Actionable Reports",
        description:
          "Easy-to-understand dashboards summarise all learning outcomes and competencies. Educators receive detailed, ready-to-use reports they can use for feedback, assessment, and personalised mentoring.",
      },
      {
        title: "Personal Growth",
        description:
          "Students discover who they are as decision-makers.They build resilience, empathy, global awareness, and confidence through repeated reflection and experience-based learning.",
      },
    ],
  },

  changeMakerAction: {
    title: "See the ChangeMaker Index in Action",
    description:
      "Explore an interactive demo of the RCMI to understand how it works, what it measures, and how it supports student growth.",
    descriptionLineBreak:
      "Explore an interactive demo of the RCMI to understand how it works, what it measures,",
    descriptionLineBreak2: "and how it supports student growth.",
  },

  benefits: {
    title: "Benefits That Shape Your Future",
    description:
      "RealLives helps you build the social, emotional, and ethical skills that matter most in life. Grow with confidence as you learn to navigate real-world challenges with purpose.",
    cards: [
      {
  ...
  pages: {
    getRcmiReport: {
      eyebrow: "RealLives ChangeMaker Index",
      heroTitle: "Your Personalised RCMI Report",
      heroSubtitle:
        "The RealLives ChangeMaker Index (RCMI) measures how you develop empathy, global awareness, and decision-making through immersive life simulations — translating your gameplay into a structured assessment of changemaking potential.",
      heroPills: ["18 Competencies", "5-Part Report", "Data-Driven Insights"],
      timeline: {
        heading: "How to Get Your Report",
        lead: "Register, play three lives, and unlock your full ChangeMaker profile.",
        steps: [
          {
            tag: "Step 1",
      ...
      journey: {
        ...
        heading: "How Your Report Works",
        lead: "Your report is a five-part journey from understanding your profile to charting your path forward.",
        partPrefix: "Part",
        parts: [
          {
            id: "profile",
      ...
      preview: {
        ...
        lead: "A rich, visual report built from your simulation data — scores, graphs, stages, and personalised recommendations.",
        images: [
          {
      ...
      about: {
        rcmiTitle: "About RealLives ChangeMaker Index",
        rcmiText:
          "RCMI analyses players' experiences across diverse socioeconomic and cultural contexts to generate meaningful insights, translating gameplay into a structured assessment of changemaking potential and social impact orientation.",
        foundationTitle: "About RealLives Foundation",
        foundationText:
          "RealLives Foundation fosters empathy, global awareness, and changemaking skills through experiential learning — helping individuals explore diverse human experiences and inspire action toward a more inclusive world.",
      },
      competency: {
        label: "Competency framework",
        heading: "18 Competencies Across 4 Clusters",
        lead: "Each cluster reflects a distinct dimension of changemaking, measured through the choices you make in simulation.",
        clusters: [
          {
            id: "personal",
            title: "Personal",
        ...
        stages: {
          heading: "Your ChangeMaker Stage",
          lead: "Progress through five stages as your competency profile develops.",
          quote: "Growth is the proof of persistence.",
          items: [
            { name: "Seed", range: "0 – 20", description: "Exploring your potential" },
            {
              name: "Sprout",
              range: "21 – 40",
      ...
      footer: {
        title: "Ready for your RCMI Report?",
        subtitle:
          "Register, play three lives, and discover your ChangeMaker score, stage, and personalised path.",
        cta: "Get Your RCMI Report",
      },
    },
    ...
    rcmiWorks: {
      ...
      keyFeatures: {
        ...
        items: [
          {
            label: "Powered by RealLives Simulation :",
            text: "The RealLives ChangeMaker Index (RCMI) is a revolutionary competency-based assessment tool that measures an individual's potential to create positive impact in their personal and professional lives.",
          },
          {
            label: "AI-Powered Score Generation :",
            text: "Advanced algorithms analyze performance across all competencies to generate accurate, personalized insights.",
          },
          {
            label: "Global Recognition :",
            text: "Developed in partnership with leading institutions including Korea University",
          },
        ],
      },
      science: {
        title: "The Science behind RCMI",
        intro:
        ...
        items: [
          {
            ...
            text: "Learning through realistic simulation and decision-making",
          },
          {
            label: "Competency-Based Education:",
            text: "Focus on skills and abilities rather than just knowledge",
          },
          {
            label: "Social Impact Research:",
            text: "Understanding the competencies that drive meaningful change",
          },
          {
            label: "Positive Psychology:",
            text: "Emphasis on strengths-based development",
          },
        ],
        closing:
      ...
      howItWorks: {
        title: "How the RealLives ChangeMaker Index Works?",
        steps: [
          {
            title: "Step 1: Making a Real-Life Decision",
            paragraphs: [
          ...
          {
            title: "Step 2: Measuring Competencies",
            paragraphs: [
          ...
          {
            title: "Step 3: Building the ChangeMaker Index",
            paragraphs: [
          ...
          {
            title: "Step 4 — View Your ChangeMaker Graph",
            paragraphs: [
          ...
          {
            title: "Step 5 — Discover Your ChangeMaker Clusters",
            paragraphs: [
              ...
              {
                label: "1 Internal / Personal Qualities –",
                text: "How you grow as an individual:Self-Awareness, Resilience, Adaptability, Persistence, Emotional Intelligence",
              },
              {
                label: "2 Interpersonal Competencies –",
                text: "How you grow as an individual:Self-Awareness, Resilience, Adaptability, Persistence, Emotional Intelligence",
              },
              {
                label: "3 Strategic Thinking –",
                text: "How you plan, solve problems, and innovate: Visionary Thinking, Creativity & Innovation, Problem-Solving Skills, Initiative, Risk-Taking, Critical Thinking",
              },
              {
                label: "4 Contextual Awareness –",
                text: "How you understand the wider world and act responsibly: Global Awareness, Ethical Responsibility",
              },
      ...
      journey: {
        title: "The ChangeMaker Journey",
        subtitle: "The Five Stages of ChangeMaker Development",
        description:
        ...
        stages: [
          {
            head: "Stage 1: Seed",
            quote: '"Just beginning to explore your potential"',
            description:
          ...
          {
            head: "Stage 2: Sprout",
            quote: '"Starting to develop foundational skills"',
            description:
          ...
          {
            head: "Stage 3: Sapling",
            quote: '"Growing stronger with a mix of strengths and growth areas"',
            description:
          ...
          {
            head: "Stage 4: Plant",
            quote: '"Well on your way, with a solid and balanced profile"',
            description:
          ...
          {
            head: "Stage 5: Fruit",
            quote: '"Thriving as a ChangeMaker, creating meaningful impact"',
            description:
      ...
      cta: {
        text: "Make decisions, grow skills, and see your impact come to life.",
        button: "Begin Your ChangeMaker Journey",
      },
    },
    ...
    certifiedInstitutes: {
      hero: {
        titleLine1: "RealLives Foundation is proud to certify",
        titleLine2: "The Orchid School Pune as a ChangeMaker School",
      },
      dashboard: {
        title: "Certified Institute Dashboard",
        description: "This is where your certified institute content goes.",
        overallScore: {
          title: "Overall ChangeMaker Score",
          description:
            "A composite score reflecting student empathy and action orientation.",
          value: "81",
          suffix: "/100",
        },
        certifiedStudents: {
          title: "Number of Certified Students",
          description:
            "Students who completed the ChangeMaker Workshop and showed applied learning.",
          value: "66",
          suffix: "Student",
        },
        drivenBy: {
          title: "Driven by RealLives Simulation",
          description:
            "The Orchid School Pune is a RealLives certified ChangeMaker School",
        },
        sdg: {
          title: "SDG's addressed through the program",
          description:
            "3 SDG's impacted through student-led projects and simulations",
        },
        nep: {
          text: "The Orchid School, Pune meets NEP 2020 experiential and competency-based learning goals through RealLives.",
          textLineBreak:
            "The Orchid School, Pune meets NEP 2020 experiential and competency-based learning goals through RealLives.",
        },
      },
      workshop: {
        button: "Workshop Pictures",
        paragraphs: [
          "After the successful completion of the ChangeMaker Program at The Orchid School, Pune, RealLives is proud to certify the school as an official ChangeMaker School. This year, the program engaged 75 students, resulting in 10 unique social business pitches and movements, along with 75 individual ChangeMaker Reports showca`sing thoughtful, impact-driven ideas.",
          "This achievement reflects the school's commitment to nurturing leadership, empathy, and social responsibility in young minds.",
        ],
      },
      praise: {
        button: "Words of Praise",
        testimonials: [
          {
            quote:
              "I used to think global problems were too big for students like us. Experiencing life through the SDGs helped me understand people's struggles and showed me that even small business ideas can create real change",
            author: "— Grade 11 Student",
          },
          {
            quote:
              "Living a life connected to the SDGs helped me feel empathy, not just learn facts. It made our social business idea more meaningful because we designed it for real people, not imaginary problems.",
            author: "— Grade 11 Student",
          },
          {
            quote:
              "This experience made me realize that empathy is the first step to changemaking. Understanding global challenges helped our team build a business idea that focuses on impact, not just profit.",
            author: "— Grade 11 Student",
          },
        ],
      },
      certificate: {
        title: "ChangeMaker Certificate Awarded to Students",
      },
    },
    ...
    ourImpact: {
      slider: {
        impact: "Impact",
        description: "of RealLives Foundation around the world",
      },
      globalStory: {
        title: "Our Global Impact Story",
        description:
      ...
      sectionTitle: "Impact Home",
      midSection: {
        title:
          "Every choice you make shapes your growth. Track your skills, explore your potential, and see how you can make a real-world impact",
        cta: "Begin Your ChangeMaking Journey",
      },
      bottomCta: {
        title: "Make decisions, grow skills, and see your impact come to life.",
        cta: "Begin Your ChangeMaking Journey",
      },
      cards: [
        {
  ...
  universities: {
    eth: {
      breadcrumb: "ETH Zurich Workshop",
    ...
    navamindradhiraj: {
      breadcrumb: "Navamindradhiraj University Bangkok",
      university: "Navamindradhiraj University, Bangkok",
      department: "Department - General Education",
      collaborator: "Prof. Krittanan Pensirisomboon",
    ...
    kyunghee: {
      breadcrumb: "KyungHee University SDG Workshop",
...
writeFileSync(localesPath, json, "utf8");
console.log(`Wrote ${outPath} (${Object.keys(en).length} top-level keys)`);
