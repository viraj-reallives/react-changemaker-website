      ...
      <div className={Styles.our_global_impact_component}>
        <div className={Styles.global_title_description_container}>
          ...
          <p className={Styles.global_second_description}>
            RealLives has delivered workshops across multiple countries,
            ...
            thinking and problem-solving skills. Students consistently report a
            deeper understanding of global issues and a stronger connection to
              ...
              <div className={Styles.bottom_card_imapct_section}>
                ...
                <div className={Styles.impact_card_data}>
                  ...
                  <div className={Styles.wapper_show_btn}>
                    {/* Empathy button first if it exists */}
                    {impactdata.empathy_title && (
                      <button
                        className={Styles.team_work_btn} // same class for consistent styling
                        style={{ backgroundColor: impactdata.empathy_bg }}
                      >
                        {impactdata.empathy_title}
                      </button>
                    )}
